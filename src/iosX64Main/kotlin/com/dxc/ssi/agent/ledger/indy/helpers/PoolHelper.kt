...
actual object PoolHelper {
    ...
    suspend fun createNonExisting(genesisFile: String, poolName: String = DEFAULT_POOL_NAME) {
        val ledgerConfig = PoolJSONParameters.CreatePoolLedgerConfigJSONParameter(genesisFile)

        Pool.createPoolLedgerConfig(poolName, ledgerConfig.toJson())
    }
    ...
    fun openExisting(
        ...
        return Pool.openPoolLedger(poolName, poolConfig.toJson())
    }
